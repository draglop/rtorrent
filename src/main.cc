  ...
  try {
    ...
    rpc::parse_command_multiple
      (rpc::make_target(),
       ...
       "method.set_key = event.download.resumed,          1_send_scrape, ((d.tracker.send_scrape,30))\n"
       "method.set_key = event.download.paused,           1_send_scrape, ((d.tracker.send_scrape,0))\n"
